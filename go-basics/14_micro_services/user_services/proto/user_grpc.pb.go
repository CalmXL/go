...
type UserClient interface {
	...
	VerifyPassword(ctx context.Context, in *PasswordVerify, opts ...grpc.CallOption) (*PasswordVeryifyPass, error)
...
func (c *userClient) VerifyPassword(ctx context.Context, in *PasswordVerify, opts ...grpc.CallOption) (*PasswordVeryifyPass, error) {
	out := new(PasswordVeryifyPass)
...
func (c *userClient) UpdateMobileNumber(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
	err := c.cc.Invoke(ctx, User_UpdateMobileNumber_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	VerifyPassword(context.Context, *PasswordVerify) (*PasswordVeryifyPass, error)
...
func (UnimplementedUserServer) VerifyPassword(context.Context, *PasswordVerify) (*PasswordVeryifyPass, error) {
